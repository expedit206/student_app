...
onMounted(() => {
    resetPWA();
    // Initialiser l'état selon la taille de l’écran
    if (window.innerWidth < 1024) {
...
<template>
    <div class="min-h-screen bg-gray-900 text-gray-100 flex overflow-hidden">
        <!-- Sidebar -->
        <aside
            :class="['sidebar flex-shrink-0 bg-gradient-to-b from-gray-800 to-gray-900 shadow-xl transition-all duration-300 fixed top-0 left-0 h-full z-20', 
                { 'w-64': (window.innerWidth >= 1024 && isSidebarExpanded) || (window.innerWidth < 1024 && isSidebarVisible), 
                  'w-16': window.innerWidth >= 1024 && !isSidebarExpanded, 
                  'w-0': window.innerWidth < 1024 && !isSidebarVisible }]">
            <div class="flex flex-col h-full">
                <!-- Logo et Toggle -->
                <div class="p-4 flex items-center justify-between bg-gray-900">
                    <div v-if="(window.innerWidth >= 1024 && isSidebarExpanded) || (window.innerWidth < 1024 && isSidebarVisible)" class="flex items-center gap-3">
                    ...
                    <button @click="toggleSidebar"
                        ...
                        <i :class="window.innerWidth >= 1024 ? (isSidebarExpanded ? 'fas fa-chevron-left' : 'fas fa-chevron-right') : (isSidebarVisible ? 'fas fa-times' : 'fas fa-bars')" class="text-lg"></i>
                    </button>
                </div>
                ...
                <nav class="flex-1 py-4">
                    ...
                    <div v-if="isApprenant" class="space-y-2">
                        <TextLink :href="route('apprenant.dashboard')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Dashboard</span>
                        </TextLink>
                        <TextLink :href="route('apprenant.disciplines')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Mes Disciplines</span>
                        </TextLink>
                        <TextLink :href="route('apprenant.notes')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Mes Notes</span>
                            <span v-if="unreadNoteNotifications > 0 && (window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible)"
                        ...
                        <TextLink :href="route('apprenant.carnet')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Mon Carnet</span>
                        </TextLink>
                        <TextLink :href="route('apprenant.progression')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Ma Progression</span>
                        </TextLink>
                    </div>
                    ...
                    <div v-if="isFormateur" class="space-y-2">
                        ...
                        <TextLink :href="route('formateur.formations')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Mes Formations</span>
                        </TextLink>
                        <TextLink :href="route('formateur.apprenants')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Mes Apprenants</span>
                        </TextLink>
                        <TextLink :href="route('formateur.notes')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Gérer les Notes</span>
                        </TextLink>
                    ...
                    <div v-if="isAdmin" class="space-y-2">
                        <TextLink :href="route('admin.dashboard')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Dashboard Admin</span>
                        </TextLink>
                        <TextLink :href="route('apprenants.index')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Apprenants</span>
                        </TextLink>
                        <TextLink :href="route('formateurs.index')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Formateurs</span>
                        </TextLink>
                        <TextLink :href="route('formations.index')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Formations</span>
                        </TextLink>
                        <TextLink :href="route('disciplines.index')"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Disciplines</span>
                        </TextLink>
                    </div>

                    <!-- Notifications -->
                    <div v-if="isApprenant && (window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible)" class="mt-6 px-4">
                    ...
                    <div class="mt-4 px-4">
                        <button v-if="isInstallable" @click="installApp"
                            ...
                            <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Installer l’app</span>
                        </button>
                    </div>
                </nav>
                        ...
                        <DropdownMenuTrigger as-child>
                            <button
                                ...
                                <span class="flex items-center gap-2">
                                    ...
                                    <span v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="flex-1">Profil</span>
                                    <span v-if="localNotifications.length && (window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible)"
                                        class="bg-red-500 text-white text-xs rounded-full px-2 py-0.5 animate-pulse">
                                        {{ localNotifications.length }}
                                    </span>
                                </span>
                                <i v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="fas fa-chevron-down"></i>
                            </button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent v-if="window.innerWidth >= 1024 ? isSidebarExpanded : isSidebarVisible" class="bg-gray-800 text-gray-100 rounded-lg shadow-lg w-48">
        ...
        <!-- Main Content -->
        <main
            :class="['flex-1 p-4 sm:p-6 bg-gray-800 overflow-y-auto transition-all duration-300 relative', window.innerWidth >= 1024 ? (isSidebarExpanded ? 'lg:ml-64' : 'lg:ml-16') : 'ml-0']">
            <button v-if="window.innerWidth < 1024 && !isSidebarVisible" @click="toggleSidebar"
