...
import InputError from '@/Components/InputError.vue'; // Ajout pour afficher les erreurs de validation
...
function submit() {
    form.put(route('disciplines.update', discipline.id), {
        preserveScroll: true,
        onSuccess: () => {
            // Optionnel : Réinitialiser ou afficher un message de succès
        },
        onError: (errors) => {
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-1 relative">
                        ...
                        <textarea id="description" v-model="form.description"
                            placeholder="Entrez une description (optionnel)" rows="4"
