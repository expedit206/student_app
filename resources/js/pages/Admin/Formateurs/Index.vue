        ...
        <div class="container mx-auto px-4 py-8 pt-2 text-gray-900 dark:text-gray-100">
            ...
            <div class="flex items-center justify-between mb-6 animate-fade-in">
                <h1 class="text-3xl font-extrabold flex items-center text-primary">
                    <i class="fas fa-chalkboard-teacher mr-3 text-blue-500 dark:text-blue-400"></i>
                ...
                <TextLink href="/formateurs/create"
                        ...
                        <thead class="bg-gray-100 dark:bg-gray-700 sticky top-0 z-10">
                            <tr>
                                ...
                                <th
                                    ...
                                    <i class="fas fa-briefcase mr-1"></i>Spécialité
                                </th>
                                <th
                                    class="w-32 px-2 py-3 text-left font-semibold text-gray-700 dark:text-gray-200 text-sm">
                                ...
                                <th
                                    ...
                                    <i class="fas fa-graduation-cap mr-1"></i>Diplôme
                                </th>
                                <th
...
.text-green-600 {
    background: linear-gradient(90deg, var(--secondary-color) 0%, #218838 100%);
    color: white;
}
