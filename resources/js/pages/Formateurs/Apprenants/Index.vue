...
const iconColors = {
    ...
    phoneHover: 'text-green-300',
    formation: 'text-purple-400',
    formationHover: 'text-purple-300',
    email: 'text-yellow-400',
    emailHover: 'text-yellow-300',
};
</script>
        ...
        <div class="p-4 sm:p-6 bg-gray-900 text-gray-100 min-h-screen overflow-hidden">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between mb-8 animate-slide-in">
                ...
                <TextLink :href="route('formateur.notes')"
                    class="mt-4 sm:mt-0 text-blue-400 hover:text-blue-300 flex items-center">
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <h2 class="text-sm sm:text-lg font-bold text-white truncate animate-text">{{
            ...
            <div class="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <div class="relative animate-fade-up">
                    ...
                    <select v-model="selectedFormation" @change="changeFormation(selectedFormation)"
                        class="w-full sm:w-64 pl-12 pr-10 py-2 sm:py-3 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none shadow-md hover:shadow-xl transition-all duration-300 hover:bg-gray-700 text-sm sm:text-base">
            ...
            <p class="mb-4 text-gray-400 text-sm sm:text-base">{{ filteredApprenants.length }} Apprenants trouvés</p>
            ...
            <div class="sm:hidden grid grid-cols-1 gap-4 bg-gray-800 rounded-xl shadow-2xl p-4 animate-fade-in"
                ...
                <div v-for="(apprenant, index) in filteredApprenants" :key="apprenant.id"
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <p class="text-sm text-gray-300" :title="apprenant.telephone">
                        ...
                        <p class="text-sm text-gray-300">
                            ...
                            <span
                                class="bg-purple-900 text-purple-300 px-2 py-1 rounded-full text-xs cursor-pointer hover:bg-purple-800 transition-colors duration-200"
                                @click="changeFormation(apprenant.formation_id)">
                                {{ getFormationTitre(apprenant.formation_id) }}
                            </span>
                        </p>
                        <p class="text-sm text-gray-300 truncate" :title="apprenant.user.email">
                            <i
