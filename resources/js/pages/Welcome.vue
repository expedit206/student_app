            ...
            <nav class="flex items-center justify-end gap-4">
                ...
                <div v-if="$page.props.auth.user">
                    <h2 class="text-xl font-bold text-white mb-4">
                        Tableau de Bord {{ $page.props.auth.user.role.charAt(0).toUpperCase() +
                            $page.props.auth.user.role.slice(1) }}
                    </h2>

                    <TextLink class="block w-full" method="post" :href="route('logout')" as="button">
